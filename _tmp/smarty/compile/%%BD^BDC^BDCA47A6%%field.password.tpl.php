<?php /* Smarty version 2.6.20, created on 2015-12-07 17:02:08
         compiled from form/field.password.tpl */ ?>
...
unset($_smarty_tpl_vars);
 ?> <?php $this->assign('_class', 'password'); ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "form/fieldclass.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?><?php $this->assign('_class', ''); ?> type="password" name="<?php echo $this->_tpl_vars['_currentFieldStruct']['field']->getName(); ?>
