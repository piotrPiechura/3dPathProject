<?php /* Smarty version 2.6.20, created on 2015-12-07 17:02:08
         compiled from cmsstartpage.tpl */ ?>
<!DOCTYPE html>
<html>
<head>
...
<!-- END HEAD -->
<!-- BEGIN BODY -->
<body class="error-body no-top lazy"  data-original="assets/img/3drill_dashboard_main_prog.jpg"  style="background-image: url('assets/img/3drill_dashboard_main_prog.jpg')"> 
...
<script>
    ...
    $(document).ready(function(){
        $(\'.container\').css(\'height\',$( window ).height() - 98);
    });
